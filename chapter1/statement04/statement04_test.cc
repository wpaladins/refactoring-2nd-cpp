...
TEST(StatementTestSuite, CreateStatementDataTestCase04) {
...
TEST(StatementTestSuite, StatementTestCase04) {
    EXPECT_STREQ(statement04(invoices[0], plays).c_str(), "\
Statement for BigCo\n\
...
TEST(StatementTestSuite, HtmlStatementTestCase04) {
    EXPECT_STREQ(htmlStatement04(invoices[0], plays).c_str(), "\
